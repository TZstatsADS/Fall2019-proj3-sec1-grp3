...
class CK(data.Dataset):
    ...
    def __init__(self, split='Training', fold = 1, transform=None):
        ...
        self.data = h5py.File('/home/lingyi/Desktop/Project3/data/data_train.h5', 'r', driver='core')
        ...
        test_number = [12,14,9,12,9,12,6,9,11,5,7,7,6,15,6,7,8,9,11,12,8,7] # the number of each class
