...
raw_img = io.imread('/home/lingyi/Desktop/Project3/all_data/cropped250/0001.jpg')
...
'red','orangered','darkorange','limegreen','darkgreen','royalblue','navy', 
'red','orangered','darkorange','limegreen','darkgreen','royalblue','navy', 'red']
for i in range(len(class_names)):
    plt.bar(ind[i], score.data.cpu().numpy()[i], width, color=color_list[i])
plt.title("Classification results ",fontsize=20)
plt.xlabel(" Expression Category ",fontsize=16)
plt.ylabel(" Classification Score ",fontsize=16)
plt.xticks(ind, class_names, rotation=90, fontsize=14)

axes=plt.subplot(1, 3, 3)
# emojis_img = io.imread('/home/lingyi/Desktop/Project3/images/emojis/%s.png' % str(class_names[int(predicted.cpu().numpy())]))
...
#plt.show()
plt.savefig(os.path.join('/home/lingyi/Desktop/Project3/images/results/0001.png'))
plt.close()
